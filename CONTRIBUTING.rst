...
Ready to contribute? Here's how to set up `oaserver` for local development.

1. Fork the `oaserver` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/oaserver.git
...
tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd oaserver
    (dvlpt) oaserver$ flake8
    (dvlpt) oaserver$ nosetests
    (dvlpt) oaserver$ tox
...
3. The pull request should work for Python 2.7, 3.4, and 3.5. Check
   https://travis-ci.org/revesansparole/oaserver/pull_requests
...
.. _issues: https://github.com/revesansparole/oaserver/issues
